...
module.exports = NodeHelper.create({
    ...
    resources: [
        ...
        // ]},
        {intervalSeconds: 10, path: '/-/vsr/get-vsr', values: [
        ...
        // ]},
        {intervalSeconds: 60, path: '/-/vehicle-info/get-vehicle-details', values: [
        ...
        {intervalSeconds: 30, path: '/-/emanager/get-emanager', values: [
    ...
    loginWeConnect: async function (config) {
        console.log(this.name + ': Logging in to WeConnect');
        // const self = this;
    ...
    readCarData: function (resource){
        ...
        // self.sendSocketNotification('WECONNECT_CARDATA', [{
        //     label: 'Batteri',
        //     value: '82',
        //     suffix: '%'
        // }]);
